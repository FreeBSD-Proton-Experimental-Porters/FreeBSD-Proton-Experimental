...
Install it:
```
pkg install -y /usr/local/poudriere/data/packages/amd64-default/All/wine-proton-11-e.11.0.20260609.pkg
```
...
/usr/local/wine-proton/bin/pkg32.sh install -y \
  -r FreeBSD-ports \
  /usr/local/poudriere/data/packages/i386-default/All/wine-proton-11-e.11.0.20260609.pkg
```
