...
setup() {
    ...
    mv "${PROTON_EXP_PATH}/files/lib/wine/${name}/x32" "${PROTON_EXP_PATH}/files/lib/wine/${name}/i386-windows" 2> /dev/null
    mv "${PROTON_EXP_PATH}/files/lib/wine/${name}/build/x32" "${PROTON_EXP_PATH}/files/lib/wine/${name}/i386-windows" 2> /dev/null
    mv "${PROTON_EXP_PATH}/files/lib/wine/${name}/build/x64" "${PROTON_EXP_PATH}/files/lib/wine/${name}/x86_64-windows" 2> /dev/null
    rm ${filename}
}
...
setup dxvk-sarek https://github.com/pythonlover02/DXVK-Sarek/releases/download/v${SAREK_VER} dxvk-sarek-${SAREK_VER}.tar.gz
