...
Install it:
```
pkg install -y /usr/local/poudriere/data/packages/amd64-default/All/wine-proton-e.10.0.20260324,1.pkg
```
...
/usr/local/wine-proton/bin/pkg32.sh install -y \
  -r FreeBSD-ports \
  /usr/local/poudriere/data/packages/i386-default/All/wine-proton-e.10.0.20260324,1.pkg
```
