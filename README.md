...
### What is this?
> This repo contains Proton 11.0.
---
...
```
cd ~
git clone -b 11.0-stable https://github.com/es-j3/FreeBSD-Proton-Experimental.git && cd FreeBSD-Proton-Experimental/emulators
cp -r /root/FreeBSD-Proton-Experimental/emulators/wine-proton-11 /usr/local/poudriere/ports/default/emulators/
```
...
poudriere bulk -j ${FREEBSD_JAIL_AMD64} \
  -b latest emulators/wine-proton-11
```
